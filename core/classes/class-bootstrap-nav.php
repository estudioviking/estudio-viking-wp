<?php
/**
 * ID_WP_Bootstrap_Nav_Walker class
 * 
 * A custom Wordpress nav walker to implement the Bootstrap 3 dropdown navigation using the Wordpress built in menu manager.
 * Inspired by the class twitter_bootstrap_nav_walker (@link https://github.com/twittem/wp-bootstrap-navwalker),
 ...
 * @since 1.0.0
 */
class ID_WP_Bootstrap_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			 ...
			 */
			if ( ! empty( $item->attr_title ) && false !== strpos( $item->attr_title, 'glyphicon' ) ) {
				$item_output .= '<a'. $attributes .'><span class="glyphicon ' . esc_attr( $item->attr_title ) . '"></span>&nbsp;';
			} elseif ( ! empty( $item->attr_title ) && false !== strpos( $item->attr_title, 'fa-' ) ) {
